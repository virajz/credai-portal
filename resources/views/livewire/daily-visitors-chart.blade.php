<div class="relative aspect-video overflow-hidden rounded-xl border border-neutral-200 bg-white dark:border-neutral-700 dark:bg-neutral-800">
    <div class="absolute inset-0 flex flex-col p-4">
        <div class="mb-2 flex items-start justify-between">
            <div class="flex-1">
                <flux:heading size="lg" class="text-neutral-900 dark:text-neutral-100">Daily Registrations</flux:heading>
                <flux:text class="text-xs text-neutral-600 dark:text-neutral-400">Last 7 days</flux:text>
            </div>
            <div class="flex items-center gap-1.5">
                <flux:icon.users class="size-4 text-neutral-500 dark:text-neutral-400" />
        ...
        <flux:chart :value="$this->chartData" class="h-full flex-1">
            <flux:chart.svg>
                <flux:chart.area field="visitors" class="text-blue-200/50 dark:text-blue-400/30" curve="smooth" />
                <flux:chart.line field="visitors" class="text-blue-500 dark:text-blue-400" curve="smooth" />
                <flux:chart.point field="visitors" class="text-blue-500 dark:text-blue-400" r="3" stroke-width="2" />
            ...
            <flux:chart.tooltip>
                ...
                <flux:chart.tooltip.value field="visitors" label="Registrations" />
            </flux:chart.tooltip>
        </flux:chart>
    </div>
</div>
