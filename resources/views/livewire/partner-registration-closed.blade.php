        ...
        <div class="space-y-6 text-center">
            ...
            <div class="space-y-2">
                ...
                <flux:subheading class="text-zinc-600 dark:text-zinc-400">
                    Partner registration for CREDAI Glam Property Show 2026 has ended.
                </flux:subheading>
            </div>
            ...
            <div class="space-y-4">
                <p class="text-zinc-700 dark:text-zinc-300">
                    You can still register as a visitor to attend the event.
                </p>

                <flux:button variant="primary" href="{{ route('visitor.register') }}" wire:navigate>
                    Register as Visitor
                </flux:button>
            </div>
