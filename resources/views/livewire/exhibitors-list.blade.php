                        ...
                        <flux:table.row :key="$exhibitor->id">
                            <flux:table.cell>
                                <div class="flex items-center gap-3">
                                    ...
                                    @else
                                        <div
                                            class="flex h-10 w-10 items-center justify-center rounded-lg bg-zinc-200 dark:bg-zinc-700">
                                            <flux:icon.building-office variant="micro" />
                                        </div>
                                    @endif
                                    <div>
                                        <div class="font-semibold">{{ $exhibitor->brand_name }}</div>
                                        <div class="text-xs text-zinc-500">{{ $exhibitor->facia_name }}</div>
                                    </div>
                                </div>
                            </flux:table.cell>
                        ...
                        <flux:table.row>
                            <flux:table.cell colspan="7" class="text-center">
                                <div class="py-12">
                                    ...
                                    @if (!$search && !$cityFilter)
                                        <flux:button variant="primary" :href="route('exhibitor.register')"
